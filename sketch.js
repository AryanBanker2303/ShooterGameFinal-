...
spawnEnemiesBottom();
spawnEnemiesBottomRight();
spawnEnemiesRight();
spawnEnemiesTopRight();
}
...
if(keyWentDown("a") && keyWentDown("w")){
  player.velocityY =-6.5;
...
deathSound.play();
  ...
  text("Press 'e' to buy lives for $2000",7,100);
  text("Health:"+ lives,5,650);
...
switch(randomiser){
  ...
  function spawnEnemiesBottomRight(){
    var enemy = createSprite(random(1500,2800),random(700,1200),random(20,40),random(20,40));
...
switch(randomiser){
  case 1:
    ...
    case 2:
      ...
      function spawnEnemiesTopRight(){
        var enemy = createSprite(random(1500,2800),random(0,-650),30,30);
        
        enemy.velocityX = -10
        enemy.velocityY = 10;
        enemy.lifetime= 200;
        enemy.rotationSpeed = random(-30,30);
        enemyGroup.add(enemy);
        randomiser = round(random(1,6));
  switch(randomiser){
    case 1:
